<script lang="ts">
let { size = 100 } = $props<{ size?: number }>();
</script>

<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" width={size} height={size} style="shape-rendering: auto; display: block; background: transparent;" xmlns:xlink="http://www.w3.org/1999/xlink"><g><g>
  <circle fill="#fb64b6" r="4" cy="50" cx="60">
  ...
  <path transform="rotate(90 50 50)" fill="#00d3f3" d="M50 50L20 50A30 30 0 0 0 80 50Z"></path>
  <path fill="#00d3f3" d="M50 50L20 50A30 30 0 0 0 80 50Z">
  ...
  <path fill="#00d3f3" d="M50 50L20 50A30 30 0 0 1 80 50Z">
    <animateTransform keyTimes="0;0.5;1" values="0 50 50;-45 50 50;0 50 50" dur="1s" repeatCount="indefinite" type="rotate" attributeName="transform"></animateTransform>
  </path>
