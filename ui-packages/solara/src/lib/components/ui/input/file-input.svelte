...
<div class="relative">
	...
	<input
		...
		{id}
		class={cn(
			"flex h-9 w-full min-w-0 rounded-md border px-3 pt-1.5 text-sm font-medium outline-none transition-[color,box-shadow] disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
